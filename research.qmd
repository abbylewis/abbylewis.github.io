...
<span class="asl">Learn more:</span>
<ul>
<li><a href="https://serc.si.edu/gcrew/genx" target="_blank">GENX</a> is a long-term experiment at the Smithsonian Environmental Research Center that tests the impact of warming on wetland carbon cycling. You can explore current data using our <a href="https://aslewis.shinyapps.io/dashboard/" target="_blank">interactive data dashboard</a>!</li>
<ul/>

## Large-scale limnology

Not all lakes respond to anthropogenic pressures in the same way. Large-scale data analyses are needed to predict changes in lake ecosystem function worldwide and prioritize management efforts. I work closely with members of the Global Lake Ecological Observatory Network (<a href="https://gleon.org/" target="_blank">GLEON</a>) to analyze patterns of ecosystem function in lakes worldwide and how these functions may change over time. 
